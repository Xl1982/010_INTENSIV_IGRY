...
class MyGame(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.player_light = None # свет от игрока
    ...
    def setup(self):
        ...
        # создаем слой освещения
        self.light_layer = LightLayer(SCREEN_WIDTH, SCREEN_HEIGHT)
        self.light_layer.set_background_color(arcade.color.BLACK)

        # создаем источники света разных цветов
        x = 400 # центр источник света по x(круг)
        y = 400 # центр источника света по y(круг)
        radius = 400 # радиус
        mode = 'hard' # сама кисть мягкость кисти
        color = arcade.csscolor.GREEN

        light = Light(x, y, radius, color, mode) # функция отрисовки луча света
        self.light_layer.add(light) # список лучей добавляем в список
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Press SPACE off/on",
